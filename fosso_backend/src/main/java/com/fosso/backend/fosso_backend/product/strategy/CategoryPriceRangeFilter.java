...
public class CategoryPriceRangeFilter implements ProductFilterStrategy{
    ...
    public Page<Product> filter(ProductFilterCriteria criteria, Pageable pageable) {
        return productRepository.findByCategoryAndPriceRangeForUser(criteria.getCategoryIds(), criteria.getMinPrice(), criteria.getMaxPrice(), pageable);
    }
}
