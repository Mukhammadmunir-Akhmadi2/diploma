...
public class ColorCategoryFilter implements  ProductFilterStrategy {
    ...
    public Page<Product> filter(ProductFilterCriteria criteria, Pageable pageable) {
        return productRepository.findByColorAndCategoryIdForUser(criteria.getColor(), criteria.getCategoryIds(), pageable);
    }
}
