...
public class GenderFilter implements ProductFilterStrategy{
    ...
    public Page<Product> filter(ProductFilterCriteria criteria, Pageable pageable) {
        return productRepository.findByGenderForUser(criteria.getGender(), pageable);
    }
}
