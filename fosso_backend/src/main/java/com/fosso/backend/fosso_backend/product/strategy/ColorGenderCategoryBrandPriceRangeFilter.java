...
public class ColorGenderCategoryBrandPriceRangeFilter implements ProductFilterStrategy {
    ...
    public Page<Product> filter(ProductFilterCriteria criteria, Pageable pageable) {
        return productRepository.findByColorGenderCategoryBrandPriceRangeForUser(
                criteria.getColor(),
                criteria.getGender(),
