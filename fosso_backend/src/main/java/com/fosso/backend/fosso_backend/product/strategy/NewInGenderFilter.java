...
public class NewInGenderFilter implements ProductFilterStrategy{
    ...
    public Page<Product> filter(ProductFilterCriteria criteria, Pageable pageable) {
        ...
        return productRepository.findProductsCreatedAfterAndGenderForUser(from, criteria.getGender(), pageable);
    }
}
