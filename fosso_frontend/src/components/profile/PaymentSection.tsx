    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
      ...
      <div className="space-y-4">
        {paymentMethods.map((payment) => (
          <div key={payment.id} className="border rounded-lg p-4 dark:border-gray-700">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">{payment.cardNumber}</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">{payment.cardHolder}</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">{t('payment.expires')}: {payment.expiryDate}</p>
                </div>
              </div>
        ...
        {paymentMethods.length === 0 && (
          <div className="text-center py-8 border rounded-md dark:border-gray-700">
            <p className="text-gray-500 dark:text-gray-400">{t('payment.noMethods')}</p>
          </div>
        )}
      </div>
